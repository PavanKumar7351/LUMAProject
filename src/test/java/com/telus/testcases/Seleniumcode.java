...
public class Seleniumcode extends BaseTest {
	public static Logger log=LogManager.getLogger(Seleniumcode.class.getName());
	...
	public static void Shopping() throws InterruptedException, ParseException {
		...
		// WebElement ss=driver.findElement(By.xpath("//span[normalize-space()='Fitness
		// Equipment']"));
		...
		// }
		// WebElement i = driver.findElement(By.xpath("//img[@alt='Proteus Fitness
		// Jackshirt']"));
		//
		// if(i.isDisplayed()){
...
//		 action.moveToElement(top).click().perform();
		...
		bt.click();
		WebElement pn=driver.findElement(By.xpath("//*[@id=\"maincontent\"]/div[3]/div[1]/div[2]/div[2]/ol/li[1]/div/div/strong/a"));
		String pn1=pn.getText();
		Assert.assertEquals(pn1,"Autumn Pullie" );
